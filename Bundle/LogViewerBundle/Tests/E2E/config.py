...
class E2EConfig:
    ...
    ADMIN_HTTP_PERF_URL:  str = f"{BASE_URL}/admin/http-performance"
    ADMIN_PERF_DASH_URL:  str = f"{BASE_URL}/admin/perf"
    ADMIN_SQL_ISSUES_URL: str = f"{BASE_URL}/admin/sql-issues"
