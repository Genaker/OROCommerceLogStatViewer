...
class LogViewerControllerTest extends TestCase
{
    ...
    private LogViewerAjaxService $ajax;
    ...
    protected function setUp(): void
    {
        ...
        $this->ajax          = $this->createMock(LogViewerAjaxService::class);
    ...
    /** @test */
    public function testLiveUpdateCallsValidatorBeforeAjaxService(): void
    {
        $this->configManager->method('get')->willReturn(true);
        ...
        $this->ajax->expects($this->never())->method('liveUpdate');
    ...
    /** @test */
    public function testUniqueEntriesReturnsJsonFromAjaxService(): void
    {
        $this->configManager->method('get')->willReturn(true);
        $this->validator->expects($this->once())->method('validate')->with('app.log');
    ...
    /** @test */
    public function testUniqueEntriesCallsValidatorBeforeAjaxService(): void
    {
        $this->configManager->method('get')->willReturn(true);
        ...
        $this->ajax->expects($this->never())->method('uniqueEntries');
