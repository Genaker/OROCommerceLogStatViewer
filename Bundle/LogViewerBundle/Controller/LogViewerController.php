...
use Genaker\Bundle\LogViewerBundle\Service\LogViewerAjaxService;
...
class LogViewerController extends AbstractController
{
    ...
    public function __construct(
        ...
        private readonly LogViewerAjaxService $ajax,
    ...
    public function liveUpdate(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->liveUpdate($fileName, $offset));
    }
    ...
    public function reload(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->reload($fileName, $lines));
    }
    ...
    public function exceptions(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->exceptions($fileName, $scanLines));
    }
    ...
    public function uniqueEntries(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->uniqueEntries($fileName, $scanLines));
    }
    ...
    public function throughput(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->throughput($fileName, $scanLines));
    }
    ...
    public function grep(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->grep($fileName, $pattern, $lines, $fullScan));
    }
    ...
    public function multiTail(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->multiTail($fileNames, $offsets));
    }
    ...
    public function multiGrep(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($this->ajax->multiGrep($fileNames, $pattern, $limitPerFile, $fullScan));
    }
